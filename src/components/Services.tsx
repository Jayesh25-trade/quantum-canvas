...
export function Services() {
  return (
    <section id="services" className="relative px-5 py-20 sm:py-28 md:py-32">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              data-cursor="hover"
              className="group gradient-border relative overflow-hidden rounded-2xl p-5 transition-all duration-500 sm:p-6"
            >
              <div
                className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                style={{ background: "radial-gradient(400px circle at 50% 0%, oklch(0.65 0.28 305 / 0.15), transparent 70%)" }}
              />
              <div className="relative">
                <s.icon className="mb-4 h-6 w-6 text-neon-cyan transition-colors group-hover:text-neon-purple sm:mb-5" />
